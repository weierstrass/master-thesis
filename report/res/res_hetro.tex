...
\begin{figure}
  ...
  \subfloat[Heterogeneous wall charge
    ]{\label{fig:res:h_setup}\includegraphics[width=0.35\textwidth]{fig/hetro_setup.pdf}}      
  \hspace{5pt} \subfloat[Array of charged squares
  ]{\label{fig:res:square}\includegraphics[width=0.35\textwidth]{fig/square_setup.pdf}}
